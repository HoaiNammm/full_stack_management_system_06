    ...
    public partial class CompleteAppDbContext : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventProcessingLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventProcessingLogs_IncomingEvents_IncomingEventId",
                        column: x => x.IncomingEventId,
                        principalTable: "IncomingEvents",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceEventId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EnableTaskNotification = table.Column<bool>(type: "bit", nullable: false),
                    EnableCommentNotification = table.Column<bool>(type: "bit", nullable: false),
                    EnableMentionNotification = table.Column<bool>(type: "bit", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventProcessingLogs_IncomingEventId",
                table: "EventProcessingLogs",
