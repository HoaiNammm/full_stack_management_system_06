  ...
  <div class="min-h-dvh flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4 py-12">
    <div class="w-full max-w-md">
      ...
      <div class="mb-8 flex flex-col items-center">
        ...
        <h1 class="text-xl font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">Create account</h1>
        <p class="mt-1 text-sm text-zinc-500 dark:text-zinc-400">Start organizing your team's work</p>
      </div>
      ...
      <div class="rounded-lg border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div class="flex flex-col gap-1">
            <label for="password" class="select-none text-sm font-medium text-zinc-700 dark:text-zinc-300">
              Password<span class="ml-0.5 text-red-500" aria-hidden="true">*</span>
            </label>
            <div class="relative">
              <input
                id="password"
            ...
            <p class="text-xs text-zinc-400 dark:text-zinc-500">Must be at least 6 characters</p>
          </div>
